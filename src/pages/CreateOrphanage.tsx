...
export default function CreateOrphanage() {
  ...
  function handleRemoveImage(index: number) {
    const imagesUpdated = images.filter((image, imageIndex) => {
  ...
  function imagesToPreviewImages(imagesToConvert: File[]): string[] {
  ...
  function handleSelectImages(event: ChangeEvent<HTMLInputElement>) {
    ...
    const allImages = images.concat(selectedImages);
